    ...
    <div className="flex min-h-screen flex-grow justify-between overflow-y-hidden">
      ...
      <div className="flex flex-col flex-grow mx-4 my-8 gap-y-8 max-w-5xl text-slate-50/50 privacy-policy">
        ...
        <p className="text-zinc-300 leading-7 font-medium tracking-wider text-lg">
          Welcome to MangoTyping! At Mangotyping, we are committed to protecting
        ...
        <p className="text-zinc-300 leading-7 font-medium tracking-wider text-lg">
          ...
          When you sign up for Mangotyping, we collect your name, email address,
          and profile picture if you choose to sign in via Google account.
        </p>
        <p className="text-zinc-300 leading-7 font-medium tracking-wider text-lg">
          <span className="text-gray-300 font-bold tracking-wider text-xl leading-7 mr-2">
            Game Data:
        ...
        <p className="text-zinc-300 leading-7 font-medium tracking-wider text-lg">
          ...
          notifications, and promotional offers related to Mangotyping.
        </p>
        <p className="text-zinc-300 leading-7 font-medium tracking-wider text-lg">
          <span className="text-gray-300 font-bold tracking-wider text-xl leading-7 mr-2">
            Cash Redemption:
          </span>
          Your PayPal email address is used solely for processing cash
          redemption requests. We do not share this information with third
          parties.
        </p>
        <p className="text-zinc-300 leading-7 font-medium tracking-wider text-lg">
          <span className="text-gray-300 font-bold tracking-wider text-xl leading-7 mr-2">
          ...
          We may use your information to detect and prevent fraudulent
          activities or unfair gaming practices.
        </p>
